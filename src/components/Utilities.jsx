...
import utilities_circle from "../images/png/utility_white_circle.png";
export const Utilities = () => {
  ...
  return (
    <>
      <section className="bg_black pt-sm-5 pt-4 mt_-2 overflow-hidden">
        <div className="myContainer">
          <h2 className="utilities_h2 pb-2 pb-sm-3 pb-md-4 pb-lg-5">
            Utilities
          </h2>
          <Slider {...settings}>
            <div
            ...
            >
              <div className="utilities_card position-relative">
                ...
                <img
                  className="position-absolute white_circle1"
                  src={utilities_circle}
                  alt="circle"
                />
                <img
                  className="position-absolute white_circle2"
                  src={utilities_circle}
                  alt="circle"
                />
              </div>
